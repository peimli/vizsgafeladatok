...
print(f"A naprendszerben egy bolygónak átlagosan {sum(holdakszama) / len(holdakszama)} holdja van.")
...
print(f"A legnagyobb térfogatú bolygó a {legnagyobbterfogataranyubolygo[0]}.")

#4.feladat:
bolygonev = input("Írd be a keresett bolygó nevét.")
bolygon = [sor.bolygo for sor in lista if sor.bolygo == bolygonev]
uzenet = "Van " if bolygon else "Sajnos nincs "
